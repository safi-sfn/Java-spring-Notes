# Named Query vs Named Native Query - Complete Guide 🚀
...
#### Rule 2: Parameter Binding Required ✅
```java
...
#### Rule 3: Database-Specific Features ✅
```java
// ✅ MySQL specific
@NamedNativeQuery(
...
### Mistake 4: Database-Specific Code in @NamedQuery ❌
...
#### 3. Result Set Mapping Best Practices ✅
```java
