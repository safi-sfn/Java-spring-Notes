...
|------|---------------|---------------------|
| **Entity** | entity | Java class mapped to database table |
| **Mapping** | mapping | Relationship between entities |
| **Annotation** | annotation | Special markers like @OneToOne |
| **Cascade** | cascade | Operations flow from parent to child |
| **JoinColumn** | join column | Foreign key column |
| **JoinTable** | join table | Intermediate table for ManyToMany |
